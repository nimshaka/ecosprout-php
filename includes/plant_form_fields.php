    ...
    <div class="row g-3">
        ...
        <div class="col-12">
            ...
            <div class="d-flex align-items-center gap-2 flex-wrap">
                <input type="file" name="image" class="form-control" id="plantImageInput"
            ...
            <div id="plantImagePreviewWrap" class="mt-2 d-none">
                <img id="plantImagePreview" src="" alt="Preview"
                     class="rounded border" style="max-height:120px;object-fit:cover;">
                <div class="small text-muted mt-1" id="plantImageFileName"></div>
            </div>
            <!-- Badge shown in Edit modal when a current image exists -->
            <div id="currentImageBadge" class="mt-2 d-none">
                <span class="badge bg-success-subtle text-success border border-success-subtle">
                    <i class="bi bi-image me-1"></i><span id="currentImageName">Current image kept</span>
                </span>
            </div>
        </div>
    </div>
